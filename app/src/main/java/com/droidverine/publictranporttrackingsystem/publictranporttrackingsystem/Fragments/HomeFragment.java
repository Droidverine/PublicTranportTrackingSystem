    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        busesbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fragmentTransaction.replace(R.id.main2cont, new BusesFragment());
                fragmentTransaction.commit();
            }
        });
        ticketsbtn=view.findViewById(R.id.ticketsbtn);
        ticketsbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                FragmentManager fragmentManager = getFragmentManager();
                FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
                fragmentTransaction.replace(R.id.main2cont, new TicketFragment());
                fragmentTransaction.commit();
            }
        });
        return view;
